...
export function ButtonIntegration({
    ...
    <> 
        ...
        <button className="w-full h-[40px] flex items-center justify-center  cursor-pointer border-[1px] border-[#E5E7EB] rounded-[10px] border-solid" onClick={() => navigate(link)}>
