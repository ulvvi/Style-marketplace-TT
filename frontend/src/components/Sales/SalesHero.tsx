...
export function SalesHero(){
    return(
        <section className="relative w-full bg-linear-to-r  from-red-grad  to-pink-grad  py-20 px-4 flex">
            <div className=" absolute bg-black/20 h-full w-full z-0 top-0 left-0"/>
            <div className="z-10 gap-6 flex flex-col items-center">
                <h2 className="text-5xl text-white z-10 font-bold">MEGA SALE</h2>
