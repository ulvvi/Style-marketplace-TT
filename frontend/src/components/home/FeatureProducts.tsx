    ...
    return (
        <>  
            <section className="bg-[#F3F4F633] mb-20 mt-20 px-4">
                ...
                <div className="flex flex-col gap-8 items-center w-full mb-12">
                ...
                <div className="px-18.5 flex justify-center">
                    <Button texto="View All Products" color="white" link="" buttonClassName="min-w-[180px]" iconSrc="/src/assets/icons/blackArrowIcon.svg"/>
                </div>
            </section>
        </>
    )
